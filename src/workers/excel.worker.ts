...
// 2. Helper Robusto: Encontra valor ignorando case/espaços
...
self.onmessage = async (e: MessageEvent) => {
    ...
    try {
        ...
        // --- MODO 2: PROCESSAMENTO SIMPLIFICADO (Sem arquivos duplos) ---
        if (action === 'process') {
            ...
            workbook.SheetNames.forEach(sheetName => {
                ...
                sheetData.forEach(row => {
                    ...
                    // Normalização Robusta das Colunas (Usa findValueInRow para achar CUSTO_S_GD)
                    ...
                    // --- CÁLCULOS ---
                    // O EGS_MAPPING já tratou de puxar CUSTO_S_GD para "Custo sem GD R$"
